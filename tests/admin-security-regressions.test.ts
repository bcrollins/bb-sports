...
test('every sensitive admin API handler authenticates before reading request or protected data', () => {
  const contracts: Array<{
    ...
    { file: 'app/api/admin/articles/route.ts', method: 'POST', firstSensitiveOperation: /req\.json\s*\(/ },
    { file: 'app/api/admin/articles/[id]/route.ts', method: 'GET', firstSensitiveOperation: /getArticleById\s*\(/ },
    { file: 'app/api/admin/articles/[id]/route.ts', method: 'PUT', firstSensitiveOperation: /req\.json\s*\(/ },
    { file: 'app/api/admin/articles/[id]/route.ts', method: 'DELETE', firstSensitiveOperation: /deleteArticle\s*\(/ },
    ...
    { file: 'app/api/admin/preview/route.ts', method: 'POST', firstSensitiveOperation: /req\.json\s*\(/ },
